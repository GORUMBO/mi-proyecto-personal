// Prueba visual CDP de 8 casos resueltos del lote 12 (carnes).
...
(async () => {
  ...
  const CASOS = [
    ['Meal-prep carne molida y frijoles', 0, /no la muevas 4 min — deja que dore \(preparación: Carne molida con calabaza\)/],
    ['Chili con carne', 0, /no la muevas 4 min — deja que dore \(preparación: Carne molida con calabaza\)/],
    ['Discada norteña', 0, /sartén FRÍO — 6 min, queda crujiente\. Deja la grasa \(preparación: Frijoles charros con tocino\)/],
    ['Alambre de res', 0, /sartén FRÍO — 6 min, queda crujiente\. Deja la grasa \(preparación: Frijoles charros con tocino\)/],
    ['Papas al horno con queso y tocino', 2, /sartén FRÍO — 6 min, queda crujiente/],
    ['Hamburguesa con huevo estrellado', 1, /sartén FRÍO — 6 min, queda crujiente/],
    ['Pollo en pipián verde', 0, /20 min\. Guarda el caldo \(preparación: Pollo cocido y deshebrado\)/],
    ['Cena: sopa de fideo con huevo', 0, /hasta que quede dorado \(no quemado\) y agrega caldo de jitomate \(preparación: Sopa de fideo aguada\)/]
  ];
