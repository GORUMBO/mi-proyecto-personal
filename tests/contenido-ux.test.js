...
function makeSandbox() {
  ...
  ['COMPLETAR_PESOS', 'COMPLETAR_LIMITES', 'COMPLETAR_FRANJAS', 'COMPLETAR_ALIMENTO', 'COMPLETAR_PLATOS',
    ...
    'BEBIDA_BASE', 'BEBIDA_VARIANTE', 'BEBIDA_LIMITES', 'COMPLETAR_COMBOS_FACILES', 'CALORIAS_FACILES_FAMILIA', 'RECETA_AUXILIAR', 'RECETA_TM5_EXTERNO', 'RECETA_TM5_ACCION', 'RECETA_TM5_COCCION'].forEach(n => { sb[n] = extractVarAssign('var ' + n); });
